...
template.helper("getDateDiff", function (time) {
...
template.helper("connetVideoPlaySrc", function (group,fileName) {
    var miyao='mircoschool&DDWX@DDCX';
    var time = parseInt(new Date().getTime()/1000);
    return videoUrl + '/' + group + '/' + fileName + '?token=' + hex_md5(fileName+miyao+time) + '&ts=' + time;
});
